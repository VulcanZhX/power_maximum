classdef SmartWindInterface <handle
    ...
    properties
        ...
        imaging
        energy
        ya_lower=-30;%%最小的偏航动作角
        ya_upper=30;%%最大的偏航动作角
        ya_options=26
    ...
    methods
        ...
        function obj=SmartWindInterface(sqz_12,turbine_diameter_vector,turbine_hub_height_vector)
            ...
            for i=1:n_turbines
                turbines{i,1}=Turbine(sqz_12,turbine_diameter_vector,turbine_hub_height_vector,i);                                             %风机对象类
            end
